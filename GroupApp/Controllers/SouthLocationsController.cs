...
namespace GroupApp.Controllers
{
    ...
    {
        private readonly SouthLocationsContext _context;

        public SouthLocationsController(SouthLocationsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address")] SouthLocations southLocations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address")] SouthLocations southLocations)
        {
